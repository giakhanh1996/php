               ...
               <?php
                    ...
                    if(isset($_SESSION['mat_hang']))
                    {
                        ...
                        for($t=0;$t<count($mang2);$t++)
                        {
                            ...
                            $sl="so_luong".$mang2[$t];
                            $thanhtien=$_SESSION[$sl]*$row['don_gia'];
                            $tongtien=$tongtien+$thanhtien;
                            echo"<tr style='background:#d1e7e9;height:25px;color:#343db0;font-family:sans-serif;font-size:13px;'><td align='center'>".$i."</td><td><input type='hidden' value='".$mang2[$t]."' name='ma[]'>".$row['ten_hang']."</td><td>".number_format($row['don_gia'],0)."</td><td><input type='text' readonly='true' value='".$_SESSION[$sl]."' name='so_luong[]' style='width:70px;text-align:right;'></td><td>".$row['don_vi_tinh']."</td><td style='font-weight:bold;width:130px;' align='right'>".number_format($thanhtien,0)." <input type='button' value='VND' style='color:red;font-weight:bold;font-family:sans-serif;font-size:13px;'></td></tr>";
                        }
                        ...
                        echo"<trtr style='height:30px;'><td colspan=7 align='right'><i style='color:red;font-family:sans-serif;font-size:13px;'>Tổng tiền bằng chữ : ".$tongtien." đồng</i></td></tr>";
                    }
                ?>
				</table>
  <table width="516" border="0" cellspacing="1" cellpadding="5" align="center">
    ...
    <tr>
      <td colspan="2" bgcolor="#99FFFF">
          ...
          <input name="Submit" type="submit" class="style5" onclick="alert("chao ban"); value="Th&#7921;c Hi&#7879;n" />
          &nbsp; &nbsp;&nbsp;
